...
int Logic_pin[] = {9, 10, 11}; // pin 10 for 1; pin 9 for 2
int Logic_bit[] = {arduino.LOW, arduino.LOW, arduino.HIGH}; 
...
void keyPressed(){
  if(key == 'w'){
    ...
    arduino.digitalWrite(Logic_pin[2], arduino.HIGH);
...
void keyReleased(){
  if(key == 'w'){
    ...
    arduino.digitalWrite(Logic_pin[2], arduino.LOW);
  }
}
